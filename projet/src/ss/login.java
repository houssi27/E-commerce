...
public class login extends JFrame {
	...
	public login() {
		...
		password.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query = "select * from admin1 where Pseudo=? and Password=?";
		...
		lblConnexionAdmin.setFont(new Font("Chalkduster", Font.PLAIN, 25));
		...
		lblNewLabel.setIcon(new ImageIcon("/Users/fd/Downloads/manager (3).png"));
		lblNewLabel.setBounds(6, 0, 64, 64);

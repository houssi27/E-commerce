...
public class modifierProds extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					modifierProds frame = new modifierProds();
	...
	public modifierProds() {
		...
		panel.setBounds(0, 0, 784, 69);
		getContentPane().add(panel);
		JLabel lblGestionproduits = new JLabel("MODIFIER PRODUIT");
		...
		comboBox.setBounds(363, 119, 148, 20);
		...
		textField_4.setBounds(363, 175, 159, 20);
		contentPane.add(textField_4);
		textField_4.setColumns(10);
		
		textField_5 = new JTextField();
		textField_5.setBounds(363, 226, 159, 20);
		contentPane.add(textField_5);
		textField_5.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(363, 356, 163, 20);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			if( textField.getText().isEmpty() || textField_2.getText().isEmpty() ||textField_3.getText().isEmpty() || textField_4.getText().isEmpty() || textField_5.getText().isEmpty() ) {
							 ...
							 c.ModProduit(p,comboBox.getSelectedItem().toString());
						 JOptionPane jop1 = new JOptionPane();
						 jop1.showMessageDialog(null, "Modification", "Vous avez modifier le produit !", JOptionPane.INFORMATION_MESSAGE);
		...
		lblQuantit.setBounds(363, 161, 79, 14);
		...
		lblPrix.setBounds(363, 208, 102, 14);
		...
		lblCategorie.setBounds(363, 103, 79, 14);
		contentPane.add(lblCategorie);
		
		JLabel label = new JLabel("");
		label.setBounds(632, 245, 100, 100);
		contentPane.add(label);
		ImageIcon prods=new ImageIcon(new ImageIcon("/Users/fd/eclipse-workspace/projet/src/pres/modf.jpg").getImage().getScaledInstance(label.getWidth(),label.getHeight(),Image.SCALE_SMOOTH));
		label.setIcon(prods);
		...
		lblMargeDeProfit.setBounds(363, 257, 113, 14);
